...
<table style="width:750px;" border="0" class="tablaDatos">
  <tr>
    <td style="color: white;" class="tdEncabezado" colspan="4">Crear Tipo de Reunión</td>
  </tr>
  <tr>
    ...
    <td class="tdDatos" style="width:11%;" >
      <g:select name="estado" from="${tipoReunionInstance.constraints.estado.inList}" value="${tipoReunionInstance?.estado}" valueMessagePrefix="tipoReunion.estado"/>
    </td>
