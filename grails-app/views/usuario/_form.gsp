...
<table style="width:745px;" border="0" class="tablaDatos">
  ...
  <td class="tdTipoDatos" style="width:10%;"><label for="nombre">
        ...
        <td class="tdDatos trAux"><g:textField  id="nom" name="nombre" required="" maxlength="100" value="${usuarioInstance?.nombre}" onkeypress="return let(event)"/></td>
</div>
  ...
  <td class="tdTipoDatos" style="width:10%;"><label for="organizacion">
        ...
        <td class="tdDatos trAux"><g:textField id="org"  name="organizacion" required=""  maxlength="100" value="${usuarioInstance?.organizacion}" onkeypress="return let2(event)"/></td>
</div></tr>
...
<tr> 
  ...
  <div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'username', 'error')} required">
	<td class="tdTipoDatos" style="width:10%;"><label for="username">
        ...
        <td class="tdDatos trAux"><g:textField  id="usu" name="username" onkeypress="return enter(event)" onchange="return let3(event)" maxlength="100" required="" value="${usuarioInstance?.username}"/></td>
</div>
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'password', 'error')} required">
	<td class="tdTipoDatos" style="width:10%;"><label for="password">
        ...
        <td class="tdDatos trAux"> <g:field  type="password" id="pas" onkeypress="return enter(event)" name="password"  required="" value=""/></td>
</div></tr>
<tr>
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'puesto', 'error')} required">
  <td class="tdTipoDatos" style="width:10%;"><label for="puesto">
        ...
        <td class="tdDatos trAux"><g:textField id="pue"  name="puesto" onkeypress="return enter(event)" onblur="boton()" required="" maxlength="100" value="${usuarioInstance?.puesto}" onkeypress="return soloLetras(event)"/></td>
</div>
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'correoElectronico', 'error')} required">
  <td class="tdTipoDatos" style="width:15%;"><label for="correoElectronico">
        ...
        <td class="tdDatos trAux"><g:field id="mail"  type="email" onkeypress="return enter(event)" name="correoElectronico"  maxlength="100" required="" value="${usuarioInstance?.correoElectronico}" onchange="verificar()" /></td>
</div></tr>
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'enabled', 'error')} ">
  <td class="tdTipoDatos" style="width:13%;"><label for="enabled">
        ...
        <td class="tdDatos trAux"><g:checkBox id="ena"  name="enabled" onkeypress="return enter(event)"  value="${usuarioInstance?.enabled}" /></td>
</div>
...
<div class="fieldcontain ${hasErrors(bean: usuarioRolInstance, field: 'rol', 'error')} required">
  <td class="tdTipoDatos" style="width:10%;"><label for="rol">
        ...
        <td class="tdDatos trAux"><g:select  id="rol" name="rol.id" onkeypress="return enter(event)"  from="${ControlDeReuniones.Rol.list()}" onchange="boton()" optionValue="${{it.authority.getAt(5..it.authority.length()-1)}}"optionKey="id" required="" value="${rolInstance}" class="many-to-one"/></td>
</div></tr>
